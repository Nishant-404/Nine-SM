...
import 'package:twentyfour_player/screens/equalizer_screen.dart';
...
import 'package:twentyfour_player/services/sleep_timer_provider.dart';
import 'package:twentyfour_player/widgets/queue_bottom_sheet.dart';
                          ...
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                _SleepTimerButton(compact: isCompactLayout),
...
class _SleepTimerButton extends ConsumerWidget {
  ...
  const _SleepTimerButton({required this.compact});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return IconButton(
      ...
      icon: Stack(
        ...
        children: [
          Icon(
            timerState.isActive ? Icons.dark_mode : Icons.dark_mode_outlined,
            color: timerState.isActive ? colorScheme.primary : colorScheme.onSurfaceVariant,
          ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTimerTile(context, ref, '5 Minutes', 2, colorScheme),
                    _buildTimerTile(context, ref, '15 Minutes', 15, colorScheme),
                    _buildTimerTile(context, ref, '30 Minutes', 30, colorScheme),
                    _buildTimerTile(context, ref, '45 Minutes', 45, colorScheme),
                    _buildTimerTile(context, ref, '60 Minutes', 60, colorScheme),
                    if (timerState.isActive) ...[
                      const Divider(),
                      ListTile(
                        leading: Icon(Icons.timer_off_outlined, color: colorScheme.error),
                        title: Text('Turn Off Timer', style: TextStyle(color: colorScheme.error)),
                        onTap: () {
  ...
  Widget _buildTimerTile(BuildContext context, WidgetRef ref, String title, int minutes, ColorScheme colorScheme) {
    return ListTile(
      leading: Icon(Icons.timelapse_rounded, color: colorScheme.primary),
      title: Text(title),
      onTap: () {
        ref.read(sleepTimerProvider.notifier).startTimer(
            ...
            onSetVolume: (volume) {
              ref.read(playbackProvider.notifier).setVolume(volume);
            }
        );
